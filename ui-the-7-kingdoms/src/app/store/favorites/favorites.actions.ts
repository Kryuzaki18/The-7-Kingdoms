...
export const addCharacterFavorite = createAction('[Favorites] Add Character', props<{ url: string; name: string }>());
...
export const addHouseFavorite = createAction('[Favorites] Add House', props<{ url: string; name: string }>());
