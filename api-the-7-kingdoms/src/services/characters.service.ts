...
export const charactersService = {
  async getAll(page: number = 1, pageSize: number = 50, name?: string, gender?: string): Promise<Character[]> {
    const response = await fetch(EXT_ROUTES.ALL_CHARACTERS(page, pageSize, name, gender));
